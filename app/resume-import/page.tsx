  ...
  return (
    <>
      <SignedIn>
        <Navbar />
        <Details />
        <main id="parser" className="h-full w-full overflow-hidden bg-gray-900">
          <div className="mx-auto mt-14 max-w-3xl rounded-md border bg-gray-900 px-10 py-10 text-center shadow-md">
            {!hasUsedAppBefore ? (
              <>
