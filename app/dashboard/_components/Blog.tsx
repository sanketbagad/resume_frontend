        ...
        <section className="py-32 bg-gray-900">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="space-y-5 sm:text-center sm:max-w-md sm:mx-auto">
                    <h1 className="text-gray-400 text-3xl font-extrabold sm:text-4xl">Latest blog posts</h1>
                    <p className="text-gray-500">Blogs that are loved by the community. Updated every hour.</p>
                            ...
                            <li className="w-full mx-auto group sm:max-w-sm" key={key}>
                                <a href={items.href}>
                                    ...
                                    <div className="mt-3 space-y-2">
                                        ...
                                        <h3 className="text-lg text-gray-300 duration-150 group-hover:text-indigo-600 font-semibold">
                                            {items.title}
                                        </h3>
                                        <p className="text-gray-400 text-sm duration-150 group-hover:text-gray-800">{items.desc}</p>
                                    </div>
                                </a>
                            </li>
                        ))
