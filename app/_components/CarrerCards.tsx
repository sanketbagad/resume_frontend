...
const members = [
    {
        ...
        ,
        company_name: "Resume.in",
        job_title: "Full stack engineer",
        job_description: "A MERN Stack Developer who can work on the front-end and back-end of the application.",
        job_type: "Full-time",
        location: "Remotely",
        ...
        job_description: "A Devops Developer who can work on CI/CD, Docker, Kubernetes, and AWS.",
        job_type: "Part-time",
        location: "Remote",
        path: "javascript:void(0)"
    }, {
        ...
        job_description: "A Frontend Developer who can work on React, Vue, or Angular.",
        job_type: "Full-time",
        location: "Remote",
        path: "/careers"
    }
    ...
    <section className="py-28 bg-gray-900">
        <div className="max-w-screen-lg mx-auto px-4 md:px-8">
            <div className="max-w-md">
                <h1 className="text-gray-200 text-2xl font-extrabold sm:text-3xl">Open Positions</h1>
                <p className="text-gray-400 mt-2">We are currently looking talent software engineers, and designers to help us in our missions and to grow up.</p>
            </div>
            <ul className="mt-12 divide-y space-y-3">
                {
                    members.map((item, idx) => (
                        <li key={idx} className="px-4 py-5 duration-150 hover:border-white hover:rounded-xl hover:bg-gray-50">
                            <Link href={`/careers/${item.job_title?.toLowerCase().split(' ').join('-')}`}
                                 className="space-y-3"
                                 >
                                <div className="flex items-center gap-x-3">
                                    ...
                                    <div>
                                        ...
                                        <h3 className="text-base text-gray-600 font-semibold mt-1">{item.job_title}</h3>
                                    </div>
                                </div>
